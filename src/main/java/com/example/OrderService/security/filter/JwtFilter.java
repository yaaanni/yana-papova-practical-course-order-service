...
import com.example.OrderService.exception.InvalidTokenException;
import com.example.OrderService.security.model.AuthUser;
import com.example.OrderService.security.service.JwtService;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        System.out.println("hello from order filter 1");
        ...
        System.out.println("hello from order filter 2");
